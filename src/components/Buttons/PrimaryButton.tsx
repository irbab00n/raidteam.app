...
const PrimaryButton = styled.button`
  ...
  min-width: ${(props: PrimaryButtonProps) => (props.width ? props.width : '100px')};
  ...
  border-width: ${(props: PrimaryButtonProps) => (props.borderSize ? props.borderSize : '2px')};
  ...
  padding-left: ${(props: PrimaryButtonProps) => (props.xPadding ? props.xPadding : '10px')};
  padding-right: ${(props: PrimaryButtonProps) => (props.xPadding ? props.xPadding : '10px')};
  padding-bottom: ${(props: PrimaryButtonProps) => (props.yPadding ? props.yPadding : '0px')};
  padding-top: ${(props: PrimaryButtonProps) => (props.yPadding ? props.yPadding : '0px')};
